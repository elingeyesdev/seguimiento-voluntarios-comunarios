  ...
  document.addEventListener('DOMContentLoaded', function () {
        ...
        if (modalMode === 'agregar') {
          ...
          if (plantilla) {
            ...
            nuevo.querySelectorAll('input[type="radio"]').forEach(r => {
              r.checked = false;
              // opcional: cambiar name para evitar colisión, pero como es maqueta lo dejamos igual
            });
          } else {
    ...
    if (sendBtn) {
      sendBtn.addEventListener('click', function () {
        ...
        // Aquí podrías luego agregar lógica para verificar selección de cuerpo
        // (por ejemplo, si algún SVG tiene clase .selected)
